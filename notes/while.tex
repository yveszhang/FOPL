...
\begin{slide}{PCF with stores}
\begin{itemize}
\item $\tlift{\tau}$ is a \emblue{lifted type}, which contains all elements of $\tau$ 
...
\begin{itemize}
\item $\tcomp\tau$ are often called \emblue{monadic types} as they can be modeled by the structure {\em monads} in category theory.
\item Typing rules:
$$
\prooftree
\Gamma \vdash e : \tau 
